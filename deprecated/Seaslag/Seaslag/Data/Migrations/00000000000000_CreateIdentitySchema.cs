...
namespace Seaslag.Data.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmed = table.Column<bool>(maxLength: 255, nullable: false),
                    ...
                    PhoneNumberConfirmed = table.Column<bool>(maxLength: 255, nullable: false),
                    TwoFactorEnabled = table.Column<bool>(maxLength: 255, nullable: false),
                    LockoutEnd = table.Column<DateTimeOffset>(maxLength: 255, nullable: true),
                    LockoutEnabled = table.Column<bool>(maxLength: 255, nullable: false),
                    AccessFailedCount = table.Column<int>(maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimValue = table.Column<string>(maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderDisplayName = table.Column<string>(maxLength: 255, nullable: true),
                    UserId = table.Column<string>(maxLength: 255, nullable: false)
                },
                constraints: table =>
                {
